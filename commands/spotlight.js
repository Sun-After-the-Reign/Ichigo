...
module.exports = {
  ...
  async run(bot, message, args) {
    ...
    try { context.drawImage(await Canvas.loadImage(lien_blade + bey1[0].replace(' ','') + ".png"), x1, y1, taille_blade, taille_blade) } catch(err) {}
    ...
    try { context.drawImage(await Canvas.loadImage(lien_blade + bey2[0].replace(' ','') + ".png"), x1, y2, taille_blade, taille_blade) } catch(err) {}
    ...
    try { context.drawImage(await Canvas.loadImage(lien_blade + bey3[0].replace(' ','') + ".png"), x1, y3, taille_blade, taille_blade) } catch(err) {}
